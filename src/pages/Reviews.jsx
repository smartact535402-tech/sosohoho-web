...
const INITIAL_REVIEWS = [
  {
    id: 'initial-1',
    name: '김민지',
    programName: '경복궁 야간 해설 투어',
    rating: 5,
    content: '달빛 아래 비치는 경복궁은 정말 환상적이었습니다! 해설사님의 전문적이고 따뜻한 설명 덕분에 역사 지식도 머리에 쏙쏙 들어오고 잊지 못할 추억을 만들었습니다. 경회루의 반영을 찍은 사진은 평생 보물로 간직할 거예요.',
    date: '2026-05-20'
  },
  {
    id: 'initial-2',
    name: '박우진',
    programName: '정동길 근대 역사 산책',
    rating: 4,
    content: '정동길의 고요하고 차분한 밤 분위기는 대단히 낭만적이네요. 복잡한 도심 한복판에 이토록 마음이 쉼을 얻을 수 있는 골목길이 숨겨져 있다는 게 정말 신기하고 좋았습니다. 붉은 벽돌 건물들이 밤하늘과 참 잘 어울려요.',
    date: '2026-05-15'
  },
  {
    id: 'initial-3',
    name: '이지아',
    programName: '북촌 한옥마을 골목길 산책',
    rating: 5,
    content: '구불구불 이어지는 오르막 한옥 골목길에서 바라보는 서울 전경은 정말 평화롭습니다. 골목길 곳곳에 깃든 역사를 친절하고 재밌게 설명해 주셔서 더욱 뜻깊었습니다.',
    date: '2026-05-10'
  }
];
